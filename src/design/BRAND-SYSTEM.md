# PolarNest Mobile Design System & Product Specification — brand system
...
- **slug:** `polarnest-mobile-design-system-product-specification`
- **source:** designmd://polarnest-mobile-design-system-product-specifica
- **primary seed color:** `#161b22`
